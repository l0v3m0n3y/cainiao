...
public class Cainiao {
    ...
    public func searchDetail(queryId: Int,lang: String = "en-US") async throws -> Any {
        return try await fetchJSON(from: "\(api)/detail.json?mailNos=\(queryId)&lang=\(lang)&language=\(lang)")
    }
}
